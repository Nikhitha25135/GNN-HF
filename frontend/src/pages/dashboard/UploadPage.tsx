...
export default function UploadPage() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      if (data && data.status === "success" && data.result) {
        r = data.result;
        console.log("✅ Extracted from data.result:", r);
        console.log("✅ imagePath in result:", r.imagePath);
        ...
        r = data;
        console.log("✅ Using direct response:", r);
        console.log("✅ imagePath in direct:", r.imagePath);
      } else {
      ...
      if (r.stage === "BINARY") {
        ...
        console.log("✅ Parsed BINARY result:", parsed);
      }
      ...
      // ------------ MULTI-LABEL ABNORMAL CASE ------------
        ...
        console.log("✅ Parsed MULTI result:", parsed);
      }

      if (!parsed) {
        console.error("❌ Failed to parse prediction response - no stage found");
        console.error("❌ r.stage value:", r?.stage);
        console.error("❌ r object:", r);
        setError({
      ...
      console.log("📸 Final result with imagePath:", parsed.imagePath);
  ...
  const handleSave = async () => {
    ...
    if (!result.imagePath) {
      console.error("❌ result.imagePath is:", result.imagePath);
      console.error("❌ Full result object:", JSON.stringify(result, null, 2));
      console.error("❌ Result keys:", Object.keys(result));
      return alert("Image path missing! Please analyze the ECG first. Check the browser console for details.");
    }
